...
# with command line options: step1 -s DQM:offlineHLTSourceOnAOD --eventcontent DQM --datatier DQMIO --conditions auto:phase1_2021_realistic --era Run3 --mc --process reRECO --filein file:step0_HLT.root -n 10
