...
# with command line options: step2 -s HARVESTING:dqmHarvesting --harvesting AtRunEnd --conditions auto:phase1_2021_realistic --era Run3 --geometry DB:Extended --mc --scenario pp --filein file:step1_RAW2DIGI_L1Reco_RECO_EI_DQM.root --filetype DQM -n -1
